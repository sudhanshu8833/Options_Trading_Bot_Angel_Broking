...
config.set('main', 'PAPER_ACCOUNT', 'DU4179021')
config.set('main', 'PAPER_USERNAME', 'sebastiandalen')
...
def candles(instrument):
    df=ib_client.market_data_history(conid=[str(instrument)], period='1d', bar='5min')
